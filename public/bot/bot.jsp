...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/ai/bot/botstyle.css">
</head>
...
<body>
    ...
    <div class="chatbot-popup">
        ...
        <div class="chat-body">
            <div class="message bot-message">
                ...
                <div class="message-text">Hey hey XD<br />Not bad</div>
            </div>
        </div>
    ...
    <script src="<%= request.getContextPath() %>/ai/bot/botscript.js"></script>
</body>
