                ...
                <div class="col-lg-9 col-12 col-custom widget-mt">
                    ...
                    <div class="blog-post-details">
                        <figure class="blog-post-thumb mb-5">
                            <img src="{{asset('public/fontend/assets/images/blog/'.$newsdetails->Image)}}" alt="Blog Image">
                        </figure>
                        <section class="blog-post-wrapper product-summery">
                            <div class="section-content section-title">
                                <h2 class="section-title-2 mb-3">{{$newsdetails->Title}}</h2>
                                <p class="mb-4">{{$newsdetails->Description}}</p>
                    ...
                    <aside class="sidebar_widget widget-mt">
                        <div class="widget_inner">
                            ...
                            <div class="widget-list mb-0">
                                <h3 class="widget-title">Sản phẩm gần đây</h3>
                                <div class="sidebar-body">
                                    <x-recent-cars />
                                </div>
                            </div>
