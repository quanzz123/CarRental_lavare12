        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Chỉnh sửa thông tin và hình ảnh slider</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.sliders.update', $slider->SlideId) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('SliderName') is-invalid @enderror" 
                                           id="SliderName" name="SliderName" value="{{ old('SliderName', $slider->SliderName) }}" 
                                ...
                                <div class="form-group mb-3">
                                    <label for="SliderUrl" class="form-label">Hình ảnh mới</label>
                                    <input type="file" class="form-control @error('SliderUrl') is-invalid @enderror" 
                                           id="SliderUrl" name="SliderUrl" accept="image/*">
                                ...
                                <div class="form-group mb-3">
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" id="Isactive" 
                                               name="Isactive" value="1" {{ old('Isactive', $slider->Isactive) ? 'checked' : '' }}>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <img src="{{ asset($slider->SliderUrl) }}" alt="{{ $slider->SliderName }}" 
                                         class="img-thumbnail d-block" style="max-width: 300px">
                                </div>
                            </div>
